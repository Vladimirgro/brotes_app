...
diagnosticos = {
    'PICADURA DE ABEJAS': 62,
    'SALMONELOSIS': 65,
    'MORDEDURA DE ARAÑA': 53,
    'ETI': 24,
    'INFLUENZA': 35,
    'IRAG': 47,
    'CÓLERA': 10,
    ...
    'EDA': 17,
    'GEPI': 28,
    'INTOXICACIÓN ALIMENTARIA': 36,
    'IRAS': 48,
    'SÍNDROME PIE MANO BOCA': 74,
    'COVID-19': 13,
    'DENGUE CON SINGNOS DE ALARMA': 14,
    'DENGUE GRAVE': 15,
    'DENGUE NO GRAVE': 16,
    'ENFERMEDAD RESPIRATORIA VIRAL': 19,
    'LEPTOSPIROSIS': 50,
    'ESAVI': 21,
    'EFE': 18,
    'TOS FERINA': 76,
    ...
    'HEPATITIS A': 31,
    'PEDICULOSIS': 61,
    'ENTEROCOLITIS POR CLOSTRIDIUM DIFFICILE': 20,
    'TUBERCULOSIS PULMONAR': 79,
    'BRONQUIOLITIS': 4,
    'BRUCELOSIS': 5,
    'CHIKUNGUNYA': 6,
    'CLUSTER': 9,  # "Cluster por Sabin"
    'ESCARLATINA': 23,
    'EXANTEMA EN ESTUDIO': 25,
    'EXANTEMA VIRAL': 26,
    'FARINGITIS AGUDA': 27,
    'GINGIVOESTOMATITIS PB HERPÉTICA': 30,
    'INFECCIÓN DEL TORRENTE SANGUÍNEO': 33,
    'INFECCIÓN INCISIONAL PROFUNDA': 34,
    'INTOXICACIÓN DE ORIGEN DESCONOCIDO': 37,
    'INTOXICACIÓN POR CLEMBUTEROL': 38,
    'INTOXICACIÓN POR GAS LP': 39,
    'INTOXICACION POR HONGOS': 46,
    'INTOXICACIÓN POR MONÓXIDO DE CARBONO': 40,
    'INTOXICACIÓN POR PICADURA DE ABEJAS': 42,
    'INTOXICACIÓN POR PLAGUICIDAS': 43,
    'INTOXICACIÓN POR RATICIDA': 44,
    'IVU': 49,
    'MONONUCLEOSIS INFECCIOSA': 52,
    'NEUMONÍA': 55,
    'NEUMONIA ASOCIADA A VENTILACION MECANICA': 56,
    'NEUMONÍA NOSOCOMIAL': 55,  # SI LA QUIERES SEPARADA, DÍME EL NOMBRE EXACTO
    'NEUMONÍA POR PSEUDOMONA AERUGINOSA': 57,
    'PAROTIDITIS': 59,
    'SEPSIS': 67,
    'SEPSIS POR ENTEROBACTERIAS': 68,
    'SÍFILIS': 69,
    'SÍNDROME COQUELUCHOIDE': 72,
    'SÍNDROME DIARREICO': 73,
    'TRIPANOSOMIASIS': 77,
    'VIRUELA SIMICA': 81,
    'ZIKA': 82,
    'AMIGDALITIS': 1,
    'TUBERCULOSIS': 78,
    'GEPI POR SALMONELLA': 29,
    'HISTOPLASMOSIS': 32,
    'SÍFILIS LATENTE': 71,
    'BACTEREMIA': 3,
    'PB. CÓLERA': 60,
    ...
    'MPOX': 54,
    'RINOFARINGITIS': 64,
    'INTOXICACIÓN POR SUSTANCIA NO ESPECIFICADA': 45,
    'PALUDISMO': 58
}
